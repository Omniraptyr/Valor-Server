           ...
           .Init("BD Spirit Orb Green",
            new State(
                ...
                new State("Main",
                    ...
                    new State("follow",
                        //new EntityExistsTransition("BD Spirit Orb Green", 3, "die"),
                        new Prioritize(
                            new Follow(2, 16, 1),
                            new Wander(0.25)
                            )
            ...
            new State(
                ...
                new State("Main",
                    ...
                    new State("follow",
                        //new EntityExistsTransition("BD Spirit Orb Blue", 3, "die"),
                        new Prioritize(
                            new Follow(2, 16, 1),
                            new Wander(0.25)
                        )
            ...
            new State(
                ...
                new State("Main",
                    ...
                    new State("follow",
                        //new EntityExistsTransition("BD Spirit Orb Purple", 3, "die"),
                        new Prioritize(
                            new Follow(2, 16, 1),
                            new Wander(0.25)
                        )
            ...
            new State(
                ...
                new State("Main",
                    ...
                    new State("follow",
                        //new EntityExistsTransition("BD Spirit Orb Orange", 3, "die"),
                        new Prioritize(
                            new Follow(2, 16, 1),
                            new Wander(0.25)
                        )
            ...
            .Init("BD Stone Orb",
            new State(
                new TransformOnDeath("BD Faint Soul", 1, 3, 0.50),
                new State("Main",
            ...
            .Init("BD Berikao, the Dark Hunter",
                new State(
                    ...
                    new State("fight1",     
                        ...
                        new TimedTransition(12000, "fight2")
                        ),
                    new State("fight2",
                        new Swirl(0.7, 4),
                        ...
                        new TimedTransition(10000, "phase")
                        ),
                    new State("phase",

    ...
    partial class BehaviorDb
    {
        ...
        .Init("Timelord's Mage",
            new State(
                ...
                new State("fight2",
                     ...
                     new Shoot(10, count: 4, shootAngle: 32, projectileIndex: 1, coolDown: 250),
        ...
        .Init("Time Sentinel",
            new State(
                ...
                new State("Rage",
                     ...
                     new Shoot(10, count: 6, projectileIndex: 1, coolDown: 3600)
                    )
                )
            )
        .Init("Time Warrior 1",
        ...
        .Init("Time Energy Void",
            new State(
                new State("fight1",
                     new Wander(0.6),
                     new Shoot(10, count: 4, shootAngle: 14, projectileIndex: 0, coolDown: 300),
                     new TimedTransition(3000, "fight2")
                    ),
                new State("fight2",
                     new Swirl(0.5, 4),
                     new ConditionalEffect(ConditionEffectIndex.ArmorBroken),
                     new Shoot(10, count: 10, projectileIndex: 1, coolDown: 150),
        ...
        .Init("Galleom of Time",
                new State(
                    ...
                    new State("LaserBeamSH",
                        ...
                        new Shoot(10, count: 1, projectileIndex: 3, coolDown: 50),
                        new Shoot(10, count: 6, projectileIndex: 0, coolDown: 2000),
                        new TimedTransition(9200, "Fight3"),
                        new State("Beam1",
                            new Shoot(8.4, count: 1, fixedAngle: 0, projectileIndex: 2, coolDown: 50),
                            new Shoot(8.4, count: 1, fixedAngle: 180, projectileIndex: 2, coolDown: 50),
                            new TimedTransition(2000, "Beam2")
                        ),
                        new State("Beam2",
                            new Shoot(8.4, count: 1, fixedAngle: 90, projectileIndex: 2, coolDown: 50),
                            new Shoot(8.4, count: 1, fixedAngle: 270, projectileIndex: 2, coolDown: 50),
                    ...
                    new State("Rage",
                        ...
                        new HealSelf(coolDown: 4000, amount: 2000),

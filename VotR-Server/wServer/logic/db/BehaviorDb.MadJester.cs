		...
		private _ MadJester = () => Behav()
			.Init("Mad Jester",
				new State(
					...
					new State("Shotgun Kiss",
						...
						new Shoot(200, count: 14, shootAngle: 3, projectileIndex: 4, predictive: 0.2, coolDown: 5, coolDownOffset: 6000),
					...
					new State("CardTrickLR",
						...
						new Shoot(200, count: 15, shootAngle: 5, projectileIndex: 8, fixedAngle: 0, coolDown: 5),
						new Shoot(200, count: 15, shootAngle: 5, projectileIndex: 8, fixedAngle: 180, coolDown: 5),
						new TimedTransition(5000, "CardTrickUD"),
						new HpLessTransition(0.50, "AwakenMask")
					),
					new State("CardTrickUD",
						new Shoot(200, count: 2, shootAngle: 15, projectileIndex: 3, predictive: 0.2, coolDown: 500),
						new Shoot(200, count: 15, shootAngle: 5, projectileIndex: 8, fixedAngle: 90, coolDown: 5),
						new Shoot(200, count: 15, shootAngle: 5, projectileIndex: 8, fixedAngle: 270, coolDown: 5),
						new TimedTransition(5000, "StateChooser"),
						new HpLessTransition(0.50, "AwakenMask")
					),
					...
					new State("Cripple",
						...
						new Shoot(30, count: 10, shootAngle: 80, projectileIndex: 8, coolDown: 5, coolDownOffset: 1000),
						new TimedTransition(5000, "StateChooser"),
						new HpLessTransition(0.50, "AwakenMask")
					),
					new State("Chase",
					...
					new State("AwakenMask",
						...
						new TimedTransition(3000, "OrderMasks")
					),
					new State("OrderMasks",
						new Order(10, "White Mask", "Comeforth"),
						new Order(10, "Dark Mask", "Comeforth"),
					...
					new State("Teleporting1",
						new SetAltTexture(2),
						new TimedTransition(90, "Teleporting3")
					),
					new State("Teleporting3",
						new SetAltTexture(3),
						new TimedTransition(90, "Teleporting4")
					),
					new State("Teleporting4",
						new SetAltTexture(4),
						new TimedTransition(90, "Teleporting5")
					),
					new State("Teleporting5",
						new SetAltTexture(5),
						new TimedTransition(90, "Teleporting6")
					),
					new State("Teleporting6",
						new SetAltTexture(6),
						new TimedTransition(90, "Teleporting7")
					),
					new State("Teleporting7",
						new SetAltTexture(7),
						new TimedTransition(90, "GoHome")
					),
					new State("GoHome",
						new ReturnToSpawn(1),
					...
					new State("Appear1",
						new SetAltTexture(5),
						new TimedTransition(90, "Appear2")
					),
					new State("Appear2",
						new SetAltTexture(4),
						new TimedTransition(90, "Appear3")
					),
					new State("Appear3",
						new SetAltTexture(3),
						new TimedTransition(90, "Appear4")
					),
					new State("Appear4",
						new SetAltTexture(2),
						new TimedTransition(90, "Done")
					),
					new State("Done",
						new SetAltTexture(0),
						new TimedTransition(90, "StateChooser")
					),
					...
					new State("Cripplex",
						...
						new Shoot(30, count: 10, shootAngle: 36, projectileIndex: 0, predictive: 0.2, coolDown: 1700),
						new Shoot(30, count: 10, shootAngle: 80, projectileIndex: 8, coolDown: 5, coolDownOffset: 1000),
						new Shoot(30, count: 10, shootAngle: 80, projectileIndex: 5, predictive: 0.5, coolDown: 15, coolDownOffset: 1000),
						new TimedTransition(5000, "StateChooserx2"),
						new HpLessTransition(0.20, "The Ultimate Show")
					),
					new State("Chasex",
					...
					new State("Teleporting1X",
						...
						new SetAltTexture(2),
						new TimedTransition(90, "Teleporting3X")
					),
					new State("Teleporting3X",
						new SetAltTexture(3),
						new TimedTransition(90, "Teleporting4X")
					),
					new State("Teleporting4X",
						new SetAltTexture(4),
						new TimedTransition(90, "Teleporting5X")
					),
					new State("Teleporting5X",
						new SetAltTexture(5),
						new TimedTransition(90, "Teleporting6X")
					),
					new State("Teleporting6X",
						new SetAltTexture(6),
						new TimedTransition(90, "Teleporting7X")
					),
					new State("Teleporting7X",
						new SetAltTexture(7),
						new TimedTransition(90, "GoHomeX")
					),
					new State("GoHomeX",
						new ReturnToSpawn(1),
					...
					new State("Appear1X",
						new SetAltTexture(5),
						new TimedTransition(90, "Appear2X")
					),
					new State("Appear2X",
						new SetAltTexture(4),
						new TimedTransition(90, "Appear3X")
					),
					new State("Appear3X",
						new SetAltTexture(3),
						new TimedTransition(90, "Appear4X")
					),
					new State("Appear4X",
						new SetAltTexture(2),
						new TimedTransition(90, "DoneX")
					),
					new State("DoneX",
						new SetAltTexture(0),
						new Shoot(30, count: 8, shootAngle: 45, projectileIndex: 8, coolDown: 1000),
						new TimedTransition(90, "StateChooserx2")
					),
				...
				new Threshold(0.10,
					new ItemLoot("Eradication Wand", 0.001),
					new ItemLoot("Magic Throwing Cards", 0.01),
					new ItemLoot("Ring of Fortune", 0.01),
					new ItemLoot("Razzmatazz Armor", 0.01),
					new ItemLoot("Jackpot", 0.00005),
					new ItemLoot("Questing Package", 1.0),
					new ItemLoot("Onrane", 0.5),
					new ItemLoot("Sor Crystal", 0.25),
                    new ItemLoot("Crashing Crescendo", 0.001),
			...
			.Init("White Mask",
				new State(
					...
					new State("Fight35%",
						new Orbit(0.5, 3, 15, "Mad Jester"),
						new Shoot(50, count: 8, shootAngle: 45, predictive: 0.2, coolDown: 200),
						new EntitiesNotExistsTransition(25, "DarkDead", "Dark Mask"),
						new HpLessTransition(0.05, "Fight5%")
					),
					new State("Fight5%",
						new Orbit(0.5, 3, 15, "Mad Jester"),
						new Shoot(50, count: 8, shootAngle: 45, predictive: 0.2, coolDown: 5)
					),
					new State("DarkDead",
						new ChangeSize(5, 150),
						...
						new HealSelf(coolDown: 999999, amount: 50000),
						new TimedTransition(3000, "FightDD")
					),
					new State("FightDD",
						new Orbit(0.5, 3, 15, "Mad Jester"),
						new Shoot(50, count: 8, shootAngle: 45, projectileIndex: 1, predictive: 0.2, coolDown: 5)
					)
				)
			)
			.Init("Dark Mask",

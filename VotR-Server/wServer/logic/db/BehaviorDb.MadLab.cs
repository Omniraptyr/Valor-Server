        ...
        .Init("Dr Terrible",
            new State(
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Short Circuit", 0.01),
                    new ItemLoot("Iron Protection", 0.01),
                    new ItemLoot("The Reactor", 0.01),
                    new ItemLoot("Conducting Wand", 0.01),
                    new ItemLoot("Scepter of Fulmination", 0.01),
                    new ItemLoot("Robe of the Mad Scientist", 0.01),

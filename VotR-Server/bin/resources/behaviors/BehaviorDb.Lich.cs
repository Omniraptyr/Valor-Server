        ...
        private _ Lich = () => Behav()
            .Init("Lich",
                new State(
                    ...
                    new State("HugeMob",
                        ...
                        new Prioritize(
                            new Protect(0.9, "Phylactery Bearer", acquireRange: 15, protectionRange: 2,
                                reprotectRange: 2),
                            new Wander(0.9)
                            ),
            ...
            .Init("Actual Lich",
                new State(
                    ...
                    new Spawn("Mummy", maxChildren: 4, coolDown: 4000, givesNoXp: false),
                    new Spawn("Mummy King", maxChildren: 2, coolDown: 4000, givesNoXp: false),
                    new Spawn("Mummy Pharaoh", maxChildren: 1, coolDown: 4000, givesNoXp: false),
                    new State("typeA",

        ...
        private _ Deathmage = () => Behav()
            ...
            .Init("Deathmage",
                new State(
                    ...
                    new Spawn("Skeleton", maxChildren: 4, coolDown: 8000, givesNoXp: false),
                    new Spawn("Skeleton Swordsman", maxChildren: 2, coolDown: 8000, givesNoXp: false),
                    new Spawn("Skeleton Veteran", maxChildren: 1, coolDown: 8000, givesNoXp: false),
                    new Spawn("Skeleton Mage", maxChildren: 1, coolDown: 8000, givesNoXp: false)
                    )
            );
    }
}
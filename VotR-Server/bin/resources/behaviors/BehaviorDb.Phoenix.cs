    ...
    partial class BehaviorDb
    {
        private _ Phoenix = () => Behav()
            ...
            .Init("Phoenix Reborn",
                ...
                new Threshold(0.1,
                new ItemLoot("Large Stony Cloth", 0.03),
                new ItemLoot("Small Stony Cloth", 0.03),
                new ItemLoot("Large Tan Diamond Cloth", 0.03),
                new ItemLoot("Small Tan Diamond Cloth", 0.03),
                new ItemLoot("Large Smiley Cloth", 0.03),
				new ItemLoot("Phoenix Ring", 0.003),
				new ItemLoot("Phoenix Wand", 0.003),

...
public class FortuneModal extends EmptyFrame {
    ...
    public function FortuneModal(_arg_1:GameSprite = null) {
        ...
        if (_local_3 != null) {
            this.creditDisplay_.draw(_local_3.credits_, 0, _local_3.tokens_, _local_3.onrane_, _local_3.kantos_);
        }
        if (_arg_1 != null) {
            this.gs_ = _arg_1;
    ...
    private function onItemSwitch(_arg_1:TimerEvent = null):void {
        ...
        if (((!((this.creditDisplay_ == null))) && (!((_local_4 == null))))) {
            this.creditDisplay_.draw(_local_4.credits_, 0, _local_4.tokens_, _local_4.onrane_, _local_4.kantos_);
        }
    }
        ...
        if ((((this.state == STATE_ROUND_1)) && (!(this.client.requestInProgress())))) {
            ...
            if (_local_2 != null) {
                if (this.boughtWithGold) {
                    ...
                    this.creditDisplay_.draw(_local_2.credits_, 0, _local_2.tokens_, _local_2.onrane_, _local_2.kantos_);
                }
                else {

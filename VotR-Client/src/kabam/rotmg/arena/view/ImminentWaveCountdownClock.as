...
public class ImminentWaveCountdownClock extends Sprite {
    ...
    private function makeNextWaveText():StaticTextDisplay {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams(TextKey.ARENA_COUNTDOWN_CLOCK_NEXT_WAVE));
        _local1.filters = [new DropShadowFilter(0, 0, 0, 1, 8, 8, 2)];
        this.countDownContainer.addChild(_local1);
        return (_local1);
    }
    ...
    private function makeCountdownText():StaticTextDisplay {
        ...
        _local1.setStringBuilder(this.countdownStringBuilder.setString(this.count.toString()));
        _local1.y = this.nextWaveText.height;
        _local1.x = ((this.nextWaveText.width / 2) - (_local1.width / 2));
        _local1.filters = [new DropShadowFilter(0, 0, 0, 1, 8, 8, 2)];
        this.countDownContainer.addChild(_local1);
        return (_local1);
    }
    ...
    private function makeWaveText():StaticTextDisplay {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams(TextKey.ARENA_COUNTDOWN_CLOCK_WAVE));
        _local1.filters = [new DropShadowFilter(0, 0, 0, 1, 8, 8, 2)];
        _local1.x = ((this.waveAsset.width / 2) - (_local1.width / 2));
        _local1.y = (((this.waveAsset.height / 2) - (_local1.height / 2)) - 15);
    ...
    private function makeWaveNumberText():StaticTextDisplay {
        ...
        _local1.y = ((this.waveText.y + this.waveText.height) - 5);
        _local1.filters = [new DropShadowFilter(0, 0, 0, 1, 8, 8, 2)];
        this.waveStartContainer.addChild(_local1);
        return (_local1);
    }
    ...
    private function makeStartText():StaticTextDisplay {
        ...
        _local1.setStringBuilder(new LineBuilder().setParams(TextKey.ARENA_COUNTDOWN_CLOCK_START));
        _local1.y = ((this.waveAsset.y + this.waveAsset.height) - 5);
        _local1.x = ((this.waveAsset.width / 2) - (_local1.width / 2));
        _local1.filters = [new DropShadowFilter(0, 0, 0, 1, 8, 8, 2)];
        this.waveStartContainer.addChild(_local1);
        return (_local1);

...
public class PlayerModel {
    ...
    public function setOnrane(_arg1:int):void {
        if (this.charList.onrane_ != _arg1) {
            this.charList.onrane_ = _arg1;
            this.onraneChanged.dispatch(_arg1);
        }
        ;
    }

    public function updateKantos():int {
        return (this.charList.kantos_);
    }

    public function setKantos(_arg1:int):void {
        if (this.charList.kantos_ != _arg1) {
            this.charList.kantos_ = _arg1;
            this.kantosChanged.dispatch(_arg1);
        }
        ;
    }
}

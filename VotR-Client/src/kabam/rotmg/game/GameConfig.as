...
import kabam.rotmg.game.view.MarkShopMediator;
...
import kabam.rotmg.markPurchaser.MarkOffersMediator;
import kabam.rotmg.markPurchaser.MarkOffersModal;
import kabam.rotmg.markPurchaser.components.MarksPanel;
import kabam.rotmg.markPurchaser.components.MarksPanelMediator;
...
public class GameConfig implements IConfig {
    ...
    private function generalGameConfiguration():void {
        ...
        this.mediatorMap.map(MarksPanel).toMediator(MarksPanelMediator);
        this.mediatorMap.map(MarkOffersModal).toMediator(MarkOffersMediator);
    ...
    private function makeGiftStatusDisplayMappings():void {
        ...
        this.mediatorMap.map(RaidLauncherButton).toMediator(MarkShopMediator);

...
public class CreditDisplay extends Sprite {
    ...
    public function CreditDisplay(_arg_1:GameSprite = null, _arg_2:Boolean = true, _arg_3:Boolean = false, _arg_4:Number = 0) {
        ...
        this.kantosText = this.makeTextField();
        waiter.push(this.kantosText.textChanged);
        addChild(this.kantosText);
        this.kantosIcon = new Bitmap(IconFactory.makeKantos());
        addChild(this.kantosIcon);
    ...
    private function onAlignHorizontal():void {
        if (this.displayFortune_) {
            ...
            this.kantosIcon.x = (this.fortuneIcon_.x);
            this.kantosIcon.y = (this.fortuneIcon_.y + 20);
    ...
    public function draw(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int = 0):void {
        ...
        if ((((((_arg_1 == this.credits_)) && (((this.displayFame_) && ((_arg_2 == this.fame_)))))) && (((this.displayFortune_) && ((_arg_3 == this.fortune_)) && ((_arg_4 == this.onrane_)) && ((_arg_5 == this.kantos_)))))) {
            return;
        }

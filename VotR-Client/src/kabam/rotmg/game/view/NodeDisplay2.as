...
public class NodeDisplay2 extends Sprite implements TooltipAble {
    ...
    public function NodeDisplay2(_arg1:Player) {
        this.player = _arg1;
        ...
        if(player.node2_== 10){
            ...
            this.tooltip = new TextToolTip(0x363636, 0x660000, "Node of Toughness", "Raises your defense and vitality by 4.", 200);
        }
        if(player.node2_== 11){
        ...
        if(player.node2_== 12){
            this.nodeTexture = TextureRedrawer.redraw(AssetLibrary.getImageFromSet("marks10x10", 11), 46, true, 0);
            this.tooltip = new TextToolTip(0x363636, 0x660000, "Node of Aid", "Raises your OVERALL restoration by 5%.", 200);
        }
        if(player.node2_== 13){
            this.nodeTexture = TextureRedrawer.redraw(AssetLibrary.getImageFromSet("marks10x10", 12), 46, true, 0);

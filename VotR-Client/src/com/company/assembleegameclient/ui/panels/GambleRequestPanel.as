...
public class GambleRequestPanel extends Panel {
    ...
    public function GambleRequestPanel(_arg1:AGameSprite, _arg2:String, _arg3:int) {
        super(_arg1);
        this.name_ = _arg2;
        this.amount_ = _arg3;
        this.title_ = new TextFieldDisplayConcrete().setSize(16).setColor(0xFFFFFF).setTextWidth(WIDTH);
        this.title_.setStringBuilder(new LineBuilder().setParams(TextKey.GAMBLEREQUESTPANEL_WANTSGAMBLE, {"name": _arg2, "amount": _arg3}));
    ...
    private function onAcceptClick(_arg1:MouseEvent):void {
        gs_.gsc_.requestGamble(this.name_, this.amount_);
        dispatchEvent(new Event(Event.COMPLETE));
    }
